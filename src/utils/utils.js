...
utils.nameToId = function (name) {
  if (parseFloat(name)) { return name } else { return name.toLowerCase().replace(/[\s]/g, "_").replace(/[\.']/g, "") }
}
...
utils.safeNumber = function (n) { return utils.isNumber(Number(n)) ? Number(n) : 0 }
